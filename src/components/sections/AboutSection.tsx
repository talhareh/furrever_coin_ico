...
export default function AboutSection() {
  return (
    <div id='about' className='bg-[#6bccd5] w-full pb-4 flex flex-col items-center relative text-white'>
      ...
      <h2 className='text-5xl sm:text-4xl lg:text-8xl font-poppins mt-16 font-semibold'>About</h2>
      
      {/* About text - responsive width and font sizes */}
      <p className='text-center w-[90%] md:w-[80%] lg:w-[60%] text-base md:text-lg lg:text-xl 2xl:text-4xl mt-8 lg:mt-14'>
      ...
      {/* Marquee animation */}
      <div className="relative w-full overflow-hidden sm:-mt-24">
