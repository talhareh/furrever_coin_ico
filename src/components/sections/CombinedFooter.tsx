    ...
    <div className="relative">
      ...
      <div className='bg-[#6bccd5] h-fit flex flex-col items-center relative z-[10] w-full pt-0 mt-[-50px]'>
        ...
        <div className='absolute bottom-10 md:right-[30%] text-white w-full md:w-auto text-center md:text-left'> 
          ...
          <div className='flex items-center justify-center md:justify-between px-8 py-8'>
      ...
      {/* Main Footer */}
      <div id='contact' className='bg-[#ffc909] w-full h-[308px] py-10 flex relative flex-col items-center z-[20] mb-2'>
